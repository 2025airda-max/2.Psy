...
async function getYaGPTResponse(userMessage) {
    ...
    const body = {
        ...
        messages: [
            {
                role: "system",
                text: "Ты — «Я Ваш личный психолог». Твоя задача — провести первичную сессию. Работай в когнитивно-поведенческом подходе с элементами экзистенциальной парадигмы. Начинай диалог с представления. Задавай открытые, уточняющие вопросы, чтобы помочь пользователю сформулировать свой запрос. Будь эмпатичным, но профессиональным."
            },
            {
                role: "user",
                text: userMessage
